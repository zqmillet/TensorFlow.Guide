...
\text{由于绝对值不可微,}&& \text{上式} &= \sum_{\mathclap{x_1, x_2, y}} \big(H(W_1x_1+ W_2x_2 + 1)) - y\big)^2\text{,} &&\text{\hphantom{由于绝对值不可微,}}\\
\text{Sigmoid 函数替换,}&& &\approx\sum_{\mathclap{x_1, x_2, y}} \big(g(W_1x_1+ W_2x_2 + 1)) - y\big)^2\text{.} &&
\end{flalign*}
